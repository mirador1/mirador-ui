...
export class QualityComponent implements OnInit, OnDestroy {
  ...
  readonly mavenSiteReports: MavenSiteReport[] = [
    { label: 'Project Summary', file: 'index.html' },
    { label: 'Surefire Tests', file: 'surefire.html' },
    { label: 'JaCoCo Coverage', file: 'jacoco/index.html' },
    { label: 'SpotBugs', file: 'spotbugs.html' },
    { label: 'CVE Scan', file: 'dependency-check-report.html' },
    { label: 'Javadoc', file: 'apidocs/index.html' },
  ];
