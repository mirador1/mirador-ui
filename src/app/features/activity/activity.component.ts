...
export class ActivityComponent {
  ...
  readonly typeFilters: (ActivityType | 'all')[] = [
    'all', 'customer-create', 'customer-update', 'customer-delete',
    'health-change', 'diagnostic-run', 'env-switch', 'bulk-import'
  ];
  ...
  typeIcon(type: ActivityType): string {
    switch (type) {
      ...
      case 'customer-update': return '~';
      case 'customer-delete': return '-';
      case 'health-change': return '!';
      case 'diagnostic-run': return '>';
      case 'env-switch': return '*';
  ...
  typeBadgeClass(type: ActivityType): string {
    switch (type) {
      case 'customer-create': return 'badge-create';
      case 'customer-update': return 'badge-update';
      case 'customer-delete': return 'badge-delete';
      case 'health-change': return 'badge-health';
      case 'diagnostic-run': return 'badge-diagnostic';
      case 'env-switch': return 'badge-env';
      case 'bulk-import': return 'badge-import';
    }
  }
}
